...
import { MapPinIcon, UsersIcon, UserPlusIcon, CheckCircleIcon } from "lucide-react";
...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    console.log("Outgoing Ids: ",outgoingIds);
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {recommendedUsers.map((user) => {
                ...
                return (
                  <div
                    key={user._id}
                    className="card bg-base-200 hover:shadow transition-all duration-300"
                  >
